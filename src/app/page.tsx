      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl">
            A modern web application for browsing and filtering posts, designed for users with unstable internet connections.
          </p>
        </div>
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          ...
          <a
            ...
            href="https://github.com/Felipedossantosf/streaver-app"
            target="_blank"
        ...
        <div className="mt-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-800 mb-2">Post Listing</h3>
              <p className="text-gray-600 text-sm">Browse all posts with a clean, card-based interface</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Filter posts by user ID with debounced search</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-800 mb-2">Connection Resilient</h3>
              <p className="text-gray-600 text-sm">Optimized for users with unstable internet connections</p>
            </div>
          </div>
        </div>
      </main>
